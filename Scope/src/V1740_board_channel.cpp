...
#pragma implementation "V1740_board_channel.h"
#endif
...
V1740BoardChannel::V1740BoardChannel( GenericBoard* parent, int ch_index, cvt_board_data* p_data, void ( *scope_refresh)( int, bool), wxMutex* p_data_mutex, AppSettings *p_app_settings):
									PhysicalBoardChannel( parent, ch_index, p_data, scope_refresh, p_data_mutex, p_app_settings)
{
}

V1740BoardChannel::~V1740BoardChannel( void)
{
}

#ifdef SAMPLE_LOCK
bool V1740BoardChannel:: ReadSamplesCache( UINT32 num_samples)
{
	bool ret= false;
	int max_log_X;
	{
...
bool V1740BoardChannel:: WriteDACOffset( void)
{
	// board offset
	...
	dac_offset+= 0x8000;
	int group_index= this->m_ch_index/ CVT_V1724_MAX_CHANNEL;
#ifndef SIMUL
	return cvt_V1724_set_channel_offset( ( cvt_V1724_data*) this->m_p_data, 1<< group_index, dac_offset)!= FALSE;
#else
	return true;
#endif
}

bool V1740BoardChannel:: WriteChannelTrigger( void)
{
	...
	int group_index= this->m_ch_index/ CVT_V1724_MAX_CHANNEL;
#ifndef SIMUL
	return cvt_V1724_set_channel_trigger( ( cvt_V1724_data*) this->m_p_data, 1<< group_index, trigger_threshold, this->m_trigger_thr_sample)!= FALSE;
#else
	return true;
#endif
}
