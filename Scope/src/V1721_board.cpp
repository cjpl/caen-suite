...
V1721Board::V1721Board( int board_index, void (*scope_refresh)( int, bool), void (*update_samples_ready_led)( bool), wxMutex *p_data_mutex, AppSettings *p_app_settings, V17XXBoard::BOARD_VARIANT board_variant): 
			V17XXBoard( board_index, scope_refresh, update_samples_ready_led, p_data_mutex, p_app_settings, board_variant)
{
}

bool V1721Board::Init( long	vme_handle)
{
...
bool V1721Board::GetBoardMemory( UINT32 &num_ksamples_per_channel)
{
